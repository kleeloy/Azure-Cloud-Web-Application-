...
Return to your GoDaddy.com products page and Below my existing DNS records, I selected "ADD:

<p>
<img src="https://github.com/kleeloy/Azure-Cloud-Web-Application-/blob/main/Diagrams/Creating%20web%20app-project1.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
</p>
Selected "Add custom domain," as picture shown:
...
<p>
<img src="https://github.com/kleeloy/Azure-Cloud-Web-Application-/blob/main/Diagrams/Project%20part%201.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
</p>
...
Now, it's time to check the unique domain that was selected to verify that the container has been successfully deployed. My cyber blog webpage should appear as shown:
